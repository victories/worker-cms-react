 ...
 * Plan cards mirror the public landing's pricing section visually so the
 * sign-up journey from the marketing page feels continuous.
 */
...
export function Register() {
  ...
  const kurumsalCard = {
    ...
    icon: Building2,
    features: tr
      ? ['Sınırsız Site', 'Sınırsız Depolama', '7/24 Destek', 'SLA Garantisi', 'Özel Entegrasyonlar', 'Beyaz Etiket']
                ...
                {allCards.map((card) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <h3 className="font-serif text-2xl text-[#FAFAF7] mb-1">{card.name}</h3>
                          ...
                          <>
                            {card.price === 0 ? (
                              ...
                              <>
                                ...
                                <span className="font-serif text-4xl text-[#FAFAF7]">{card.price}</span>
                                <span className="text-[#8A8A93] text-sm">/ay</span>
                              </>
                            )}
                          </>
                        )}
