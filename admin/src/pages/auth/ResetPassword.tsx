        ...
        <div className="rounded-2xl border border-[#1B1B20] bg-[#0F0F11]/90 backdrop-blur-sm p-8 shadow-2xl shadow-black/40">
          {!token ? (
            <div className="text-center">
              <h1 className="font-serif text-2xl text-[#FAFAF7] mb-2">Geçersiz Bağlantı</h1>
              <p className="text-sm text-[#8A8A93] mb-7">
            ...
            <div className="text-center">
              ...
              <h1 className="font-serif text-2xl text-[#FAFAF7] mb-2">Şifre Değiştirildi</h1>
              <p className="text-sm text-[#8A8A93] mb-7 leading-relaxed">
                Şifren başarıyla değiştirildi. Yeni şifrenle giriş yapabilirsin.
              </p>
              <Link
                to="/login"
                className="inline-flex items-center justify-center px-5 h-11 rounded-lg font-medium text-[#0A0A0B] bg-gradient-to-br from-[#F5A524] to-[#E89414] hover:from-[#FFB638] hover:to-[#F5A524] shadow-lg shadow-amber-500/20 transition-all"
              >
                Giriş Yap
              </Link>
            </div>
            ...
            <>
              <div className="text-center mb-7">
                ...
                <h1 className="font-serif text-3xl text-[#FAFAF7] mb-1.5">Yeni Şifre Belirle</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label htmlFor="new_password" className="text-xs font-medium uppercase tracking-wider font-mono">
                    Yeni Şifre
                  </label>
                  <input
                    id="new_password"
                ...
                <div className="space-y-1.5">
                  <label htmlFor="confirm_password" className="text-xs font-medium uppercase tracking-wider font-mono">
                    Şifre Tekrar
                  </label>
                  <input
                    id="confirm_password"
