                  ...
                  {dnsCheck.lookups?.some((l: any) => l.typo && l.found?.length) ? (
                    <div className="text-[11px] border-l-2 border-amber-500 bg-amber-50 dark:bg-amber-950/20 px-2 py-1.5 rounded">
                      ...
                      <p className="text-muted-foreground">
                        {lang === 'tr'
                          ? "DNS sağlayıcın \"Host/AD\" alanına yazdığın değerin sonuna otomatik domain ekliyor. Düzeltmek için kayıtları sil ve \"Host\" alanına SADECE alt parçayı yaz (örn. \"_acme-challenge\" yaz, \"_acme-challenge.example.com\" değil)."
