...
//
// When a customer points their apex domain (e.g. example.com) at
...
domains.post('/acme', async (c) => {
  ...
  //   "http://example.com/.well-known/acme-challenge/F4IIEHYJ_GOakM1..."
  // or just "example.com/.well-known/acme-challenge/F4IIEHYJ_GOakM1...".
...
// GET /api/domains/acme/dns-check?domain=example.com — query the public
